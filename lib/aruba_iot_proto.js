...
$root.IMTelemetry = (function() {
    ...
    IMTelemetry.deviceClassDetail = (function() {

        /**
         * Properties of a deviceClassDetail.
         * @memberof IMTelemetry
         * @interface IdeviceClassDetail
         * @property {number} name deviceClassDetail name
         * @property {number} count deviceClassDetail count
         */

        /**
         * Constructs a new deviceClassDetail.
         * @memberof IMTelemetry
         * @classdesc Represents a deviceClassDetail.
         * @implements IdeviceClassDetail
         * @constructor
         * @param {IMTelemetry.IdeviceClassDetail=} [properties] Properties to set
         */
        function deviceClassDetail(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * deviceClassDetail name.
         * @member {number} name
         * @memberof IMTelemetry.deviceClassDetail
         * @instance
         */
        deviceClassDetail.prototype.name = 0;

        /**
         * deviceClassDetail count.
         * @member {number} count
         * @memberof IMTelemetry.deviceClassDetail
         * @instance
         */
        deviceClassDetail.prototype.count = 0;

        /**
         * Creates a new deviceClassDetail instance using the specified properties.
         * @function create
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {IMTelemetry.IdeviceClassDetail=} [properties] Properties to set
         * @returns {IMTelemetry.deviceClassDetail} deviceClassDetail instance
         */
        deviceClassDetail.create = function create(properties) {
            return new deviceClassDetail(properties);
        };

        /**
         * Encodes the specified deviceClassDetail message. Does not implicitly {@link IMTelemetry.deviceClassDetail.verify|verify} messages.
         * @function encode
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {IMTelemetry.IdeviceClassDetail} message deviceClassDetail message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        deviceClassDetail.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified deviceClassDetail message, length delimited. Does not implicitly {@link IMTelemetry.deviceClassDetail.verify|verify} messages.
         * @function encodeDelimited
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {IMTelemetry.IdeviceClassDetail} message deviceClassDetail message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        deviceClassDetail.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a deviceClassDetail message from the specified reader or buffer.
         * @function decode
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {IMTelemetry.deviceClassDetail} deviceClassDetail
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        deviceClassDetail.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.IMTelemetry.deviceClassDetail();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a deviceClassDetail message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        deviceClassDetail.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a deviceClassDetail message.
         * @function verify
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        deviceClassDetail.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        /**
         * Creates a deviceClassDetail message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {IMTelemetry.deviceClassDetail} deviceClassDetail
         */
        deviceClassDetail.fromObject = function fromObject(object) {
            if (object instanceof $root.IMTelemetry.deviceClassDetail)
                return object;
            var message = new $root.IMTelemetry.deviceClassDetail();
            if (object.name != null)
        ...
        /**
         * Creates a plain object from a deviceClassDetail message. Also converts values to other types if specified.
         * @function toObject
         * @memberof IMTelemetry.deviceClassDetail
         * @static
         * @param {IMTelemetry.deviceClassDetail} message deviceClassDetail
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        deviceClassDetail.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this deviceClassDetail to JSON.
         * @function toJSON
         * @memberof IMTelemetry.deviceClassDetail
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        deviceClassDetail.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    IMTelemetry.TransportProfileData = (function() {

        /**
         * Properties of a TransportProfileData.
         * @memberof IMTelemetry
         * @interface ITransportProfileData
         * @property {string} name TransportProfileData name
         * @property {Array.<IMTelemetry.IdeviceClassDetail>|null} [devClass] TransportProfileData devClass
         * @property {number|Long} txBytes TransportProfileData txBytes
         * @property {number|Long} rxBytes TransportProfileData rxBytes
         * @property {number} updateDeviceCount TransportProfileData updateDeviceCount
         * @property {number} serverType TransportProfileData serverType
         */

        /**
         * Constructs a new TransportProfileData.
         * @memberof IMTelemetry
         * @classdesc Represents a TransportProfileData.
         * @implements ITransportProfileData
         * @constructor
         * @param {IMTelemetry.ITransportProfileData=} [properties] Properties to set
         */
        function TransportProfileData(properties) {
            this.devClass = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * TransportProfileData name.
         * @member {string} name
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.name = "";

        /**
         * TransportProfileData devClass.
         * @member {Array.<IMTelemetry.IdeviceClassDetail>} devClass
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.devClass = $util.emptyArray;

        /**
         * TransportProfileData txBytes.
         * @member {number|Long} txBytes
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.txBytes = $util.Long ? $util.Long.fromBits(0,0,true) : 0;

        /**
         * TransportProfileData rxBytes.
         * @member {number|Long} rxBytes
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.rxBytes = $util.Long ? $util.Long.fromBits(0,0,true) : 0;

        /**
         * TransportProfileData updateDeviceCount.
         * @member {number} updateDeviceCount
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.updateDeviceCount = 0;

        /**
         * TransportProfileData serverType.
         * @member {number} serverType
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         */
        TransportProfileData.prototype.serverType = 0;

        /**
         * Creates a new TransportProfileData instance using the specified properties.
         * @function create
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {IMTelemetry.ITransportProfileData=} [properties] Properties to set
         * @returns {IMTelemetry.TransportProfileData} TransportProfileData instance
         */
        TransportProfileData.create = function create(properties) {
            return new TransportProfileData(properties);
        };

        /**
         * Encodes the specified TransportProfileData message. Does not implicitly {@link IMTelemetry.TransportProfileData.verify|verify} messages.
         * @function encode
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {IMTelemetry.ITransportProfileData} message TransportProfileData message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        TransportProfileData.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.name);
            if (message.devClass != null && message.devClass.length)
                for (var i = 0; i < message.devClass.length; ++i)
                    $root.IMTelemetry.deviceClassDetail.encode(message.devClass[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            writer.uint32(/* id 3, wireType 0 =*/24).uint64(message.txBytes);
            writer.uint32(/* id 4, wireType 0 =*/32).uint64(message.rxBytes);
            writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.updateDeviceCount);
            writer.uint32(/* id 6, wireType 0 =*/48).uint32(message.serverType);
            return writer;
        };

        /**
         * Encodes the specified TransportProfileData message, length delimited. Does not implicitly {@link IMTelemetry.TransportProfileData.verify|verify} messages.
         * @function encodeDelimited
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {IMTelemetry.ITransportProfileData} message TransportProfileData message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        TransportProfileData.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a TransportProfileData message from the specified reader or buffer.
         * @function decode
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {IMTelemetry.TransportProfileData} TransportProfileData
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TransportProfileData.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.IMTelemetry.TransportProfileData();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    if (!(message.devClass && message.devClass.length))
                        message.devClass = [];
                    message.devClass.push($root.IMTelemetry.deviceClassDetail.decode(reader, reader.uint32()));
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.updateDeviceCount = reader.uint32();
                    break;
                case 6:
            ...
            if (!message.hasOwnProperty("name"))
                throw $util.ProtocolError("missing required 'name'", { instance: message });
            if (!message.hasOwnProperty("txBytes"))
                throw $util.ProtocolError("missing required 'txBytes'", { instance: message });
            if (!message.hasOwnProperty("rxBytes"))
                throw $util.ProtocolError("missing required 'rxBytes'", { instance: message });
            if (!message.hasOwnProperty("updateDeviceCount"))
                throw $util.ProtocolError("missing required 'updateDeviceCount'", { instance: message });
        ...
        /**
         * Decodes a TransportProfileData message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TransportProfileData.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a TransportProfileData message.
         * @function verify
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        TransportProfileData.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!$util.isString(message.name))
                return "name: string expected";
            if (message.devClass != null && message.hasOwnProperty("devClass")) {
                if (!Array.isArray(message.devClass))
                    return "devClass: array expected";
                for (var i = 0; i < message.devClass.length; ++i) {
                    var error = $root.IMTelemetry.deviceClassDetail.verify(message.devClass[i]);
                    if (error)
                        return "devClass." + error;
                }
            }
            ...
            if (!$util.isInteger(message.updateDeviceCount))
                return "updateDeviceCount: integer expected";
        ...
        /**
         * Creates a TransportProfileData message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {IMTelemetry.TransportProfileData} TransportProfileData
         */
        TransportProfileData.fromObject = function fromObject(object) {
            if (object instanceof $root.IMTelemetry.TransportProfileData)
                return object;
            var message = new $root.IMTelemetry.TransportProfileData();
            if (object.name != null)
                message.name = String(object.name);
            if (object.devClass) {
                if (!Array.isArray(object.devClass))
                    throw TypeError(".IMTelemetry.TransportProfileData.devClass: array expected");
                message.devClass = [];
                for (var i = 0; i < object.devClass.length; ++i) {
                    if (typeof object.devClass[i] !== "object")
                        throw TypeError(".IMTelemetry.TransportProfileData.devClass: object expected");
                    message.devClass[i] = $root.IMTelemetry.deviceClassDetail.fromObject(object.devClass[i]);
                }
            }
            ...
            if (object.updateDeviceCount != null)
                message.updateDeviceCount = object.updateDeviceCount >>> 0;
        ...
        /**
         * Creates a plain object from a TransportProfileData message. Also converts values to other types if specified.
         * @function toObject
         * @memberof IMTelemetry.TransportProfileData
         * @static
         * @param {IMTelemetry.TransportProfileData} message TransportProfileData
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        TransportProfileData.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
            ...
            if (message.devClass && message.devClass.length) {
                object.devClass = [];
                for (var j = 0; j < message.devClass.length; ++j)
                    object.devClass[j] = $root.IMTelemetry.deviceClassDetail.toObject(message.devClass[j], options);
            }
            ...
            if (message.updateDeviceCount != null && message.hasOwnProperty("updateDeviceCount"))
                object.updateDeviceCount = message.updateDeviceCount;
        ...
        /**
         * Converts this TransportProfileData to JSON.
         * @function toJSON
         * @memberof IMTelemetry.TransportProfileData
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        TransportProfileData.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return TransportProfileData;
    })();

    IMTelemetry.Container = (function() {

        /**
         * Properties of a Container.
         * @memberof IMTelemetry
         * @interface IContainer
         * @property {Array.<IMTelemetry.ITransportProfileData>|null} [transportProfile] Container transportProfile
         */
         ...
         * @constructor
         * @param {IMTelemetry.IContainer=} [properties] Properties to set
         */
        ...
        /**
         * Container transportProfile.
         * @member {Array.<IMTelemetry.ITransportProfileData>} transportProfile
         * @memberof IMTelemetry.Container
         * @instance
         */
        Container.prototype.transportProfile = $util.emptyArray;
         ...
         * @static
         * @param {IMTelemetry.IContainer=} [properties] Properties to set
         * @returns {IMTelemetry.Container} Container instance
         */
        ...
        /**
         * Encodes the specified Container message. Does not implicitly {@link IMTelemetry.Container.verify|verify} messages.
         * @function encode
         * @memberof IMTelemetry.Container
         * @static
         * @param {IMTelemetry.IContainer} message Container message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Container.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.transportProfile != null && message.transportProfile.length)
                for (var i = 0; i < message.transportProfile.length; ++i)
                    $root.IMTelemetry.TransportProfileData.encode(message.transportProfile[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Container message, length delimited. Does not implicitly {@link IMTelemetry.Container.verify|verify} messages.
         * @function encodeDelimited
         * @memberof IMTelemetry.Container
         * @static
         * @param {IMTelemetry.IContainer} message Container message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {IMTelemetry.Container} Container
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Container.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.IMTelemetry.Container();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.transportProfile && message.transportProfile.length))
                        message.transportProfile = [];
                    message.transportProfile.push($root.IMTelemetry.TransportProfileData.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        Container.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.transportProfile != null && message.hasOwnProperty("transportProfile")) {
                if (!Array.isArray(message.transportProfile))
                    return "transportProfile: array expected";
                for (var i = 0; i < message.transportProfile.length; ++i) {
                    var error = $root.IMTelemetry.TransportProfileData.verify(message.transportProfile[i]);
                    if (error)
                        return "transportProfile." + error;
                }
            }
            return null;
        };
        ...
        Container.fromObject = function fromObject(object) {
            if (object instanceof $root.IMTelemetry.Container)
                return object;
            var message = new $root.IMTelemetry.Container();
            if (object.transportProfile) {
                if (!Array.isArray(object.transportProfile))
                    throw TypeError(".IMTelemetry.Container.transportProfile: array expected");
                message.transportProfile = [];
                for (var i = 0; i < object.transportProfile.length; ++i) {
                    if (typeof object.transportProfile[i] !== "object")
                        throw TypeError(".IMTelemetry.Container.transportProfile: object expected");
                    message.transportProfile[i] = $root.IMTelemetry.TransportProfileData.fromObject(object.transportProfile[i]);
                }
            }
            return message;
        };
         ...
         * @memberof IMTelemetry.Container
         * @static
         * @param {IMTelemetry.Container} message Container
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Container.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.arrays || options.defaults)
                object.transportProfile = [];
            if (message.transportProfile && message.transportProfile.length) {
                object.transportProfile = [];
                for (var j = 0; j < message.transportProfile.length; ++j)
                    object.transportProfile[j] = $root.IMTelemetry.TransportProfileData.toObject(message.transportProfile[j], options);
            }
            return object;
        };
