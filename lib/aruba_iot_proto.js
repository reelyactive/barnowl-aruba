/**
 * Copyright Aruba 2020
 * (Used with permission pending official open source release on GitHub)
 */
...
$root.aruba_telemetry = (function() {
    ...
    aruba_telemetry.DeviceCount = (function() {
         ...
         * @property {number|null} [dev_wiliot] DeviceCount dev_wiliot
         */
        ...
        /**
         * DeviceCount dev_wiliot.
         * @member {number} dev_wiliot
         * @memberof aruba_telemetry.DeviceCount
         * @instance
         */
        DeviceCount.prototype.dev_wiliot = 0;
        ...
        DeviceCount.encode = function encode(message, writer) {
            ...
            if (message.dev_wiliot != null && message.hasOwnProperty("dev_wiliot"))
                writer.uint32(/* id 21, wireType 0 =*/168).int32(message.dev_wiliot);
            return writer;
        };
        ...
        DeviceCount.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 20:
                    ...
                    break;
                case 21:
                    message.dev_wiliot = reader.int32();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        DeviceCount.verify = function verify(message) {
            ...
            if (message.dev_wiliot != null && message.hasOwnProperty("dev_wiliot"))
                if (!$util.isInteger(message.dev_wiliot))
                    return "dev_wiliot: integer expected";
            return null;
        };
        ...
        DeviceCount.fromObject = function fromObject(object) {
            ...
            if (object.dev_wiliot != null)
                message.dev_wiliot = object.dev_wiliot | 0;
            return message;
        };
        ...
        DeviceCount.toObject = function toObject(message, options) {
            ...
            if (message.dev_wiliot != null && message.hasOwnProperty("dev_wiliot"))
                object.dev_wiliot = message.dev_wiliot;
            return object;
        };
...
$root.bd = (function() {
    ...
    bd.Timestamp = (function() {
         ...
         * @constructor
         * @param {bd.ITimestamp=} [properties] Properties to set
         */
         ...
         * @static
         * @param {bd.ITimestamp=} [properties] Properties to set
         * @returns {bd.Timestamp} Timestamp instance
         */
        ...
        /**
         * Encodes the specified Timestamp message. Does not implicitly {@link bd.Timestamp.verify|verify} messages.
         * @function encode
         * @memberof bd.Timestamp
         * @static
         * @param {bd.ITimestamp} message Timestamp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Timestamp message, length delimited. Does not implicitly {@link bd.Timestamp.verify|verify} messages.
         * @function encodeDelimited
         * @memberof bd.Timestamp
         * @static
         * @param {bd.ITimestamp} message Timestamp message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {bd.Timestamp} Timestamp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Timestamp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.bd.Timestamp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Timestamp.fromObject = function fromObject(object) {
            if (object instanceof $root.bd.Timestamp)
                return object;
            var message = new $root.bd.Timestamp();
         ...
         * @memberof bd.Timestamp
         * @static
         * @param {bd.Timestamp} message Timestamp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    bd.SignalLog = (function() {

        /**
         * Properties of a SignalLog.
         * @memberof bd
         * @interface ISignalLog
         * @property {Array.<bd.ISignalLogEntry>|null} [signals] SignalLog signals
         * @property {number|Long} seqno SignalLog seqno
         */

        /**
         * Constructs a new SignalLog.
         * @memberof bd
         * @classdesc Represents a SignalLog.
         * @implements ISignalLog
         * @constructor
         * @param {bd.ISignalLog=} [properties] Properties to set
         */
        function SignalLog(properties) {
            this.signals = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * SignalLog signals.
         * @member {Array.<bd.ISignalLogEntry>} signals
         * @memberof bd.SignalLog
         * @instance
         */
        SignalLog.prototype.signals = $util.emptyArray;
         ...
         * @instance
         */
        SignalLog.prototype.seqno = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * Creates a new SignalLog instance using the specified properties.
         * @function create
         * @memberof bd.SignalLog
         * @static
         * @param {bd.ISignalLog=} [properties] Properties to set
         * @returns {bd.SignalLog} SignalLog instance
         */
        SignalLog.create = function create(properties) {
            return new SignalLog(properties);
        };

        /**
         * Encodes the specified SignalLog message. Does not implicitly {@link bd.SignalLog.verify|verify} messages.
         * @function encode
         * @memberof bd.SignalLog
         * @static
         * @param {bd.ISignalLog} message SignalLog message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SignalLog.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.signals != null && message.signals.length)
                for (var i = 0; i < message.signals.length; ++i)
                    $root.bd.SignalLogEntry.encode(message.signals[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            writer.uint32(/* id 2, wireType 0 =*/16).int64(message.seqno);
            return writer;
        };

        /**
         * Encodes the specified SignalLog message, length delimited. Does not implicitly {@link bd.SignalLog.verify|verify} messages.
         * @function encodeDelimited
         * @memberof bd.SignalLog
         * @static
         * @param {bd.ISignalLog} message SignalLog message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SignalLog.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SignalLog message from the specified reader or buffer.
         * @function decode
         * @memberof bd.SignalLog
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {bd.SignalLog} SignalLog
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignalLog.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.bd.SignalLog();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.signals && message.signals.length))
                        message.signals = [];
                    message.signals.push($root.bd.SignalLogEntry.decode(reader, reader.uint32()));
                    break;
                case 2:
        ...
        /**
         * Decodes a SignalLog message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof bd.SignalLog
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignalLog.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SignalLog.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.signals != null && message.hasOwnProperty("signals")) {
                ...
                for (var i = 0; i < message.signals.length; ++i) {
                    var error = $root.bd.SignalLogEntry.verify(message.signals[i]);
                    if (error)
        ...
        /**
         * Creates a SignalLog message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof bd.SignalLog
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {bd.SignalLog} SignalLog
         */
        SignalLog.fromObject = function fromObject(object) {
            if (object instanceof $root.bd.SignalLog)
                return object;
            var message = new $root.bd.SignalLog();
            if (object.signals) {
                if (!Array.isArray(object.signals))
                    throw TypeError(".bd.SignalLog.signals: array expected");
                message.signals = [];
                for (var i = 0; i < object.signals.length; ++i) {
                    if (typeof object.signals[i] !== "object")
                        throw TypeError(".bd.SignalLog.signals: object expected");
                    message.signals[i] = $root.bd.SignalLogEntry.fromObject(object.signals[i]);
                }
            }
        ...
        /**
         * Creates a plain object from a SignalLog message. Also converts values to other types if specified.
         * @function toObject
         * @memberof bd.SignalLog
         * @static
         * @param {bd.SignalLog} message SignalLog
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SignalLog.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
            ...
            if (message.signals && message.signals.length) {
                ...
                for (var j = 0; j < message.signals.length; ++j)
                    object.signals[j] = $root.bd.SignalLogEntry.toObject(message.signals[j], options);
            }
        ...
        /**
         * Converts this SignalLog to JSON.
         * @function toJSON
         * @memberof bd.SignalLog
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SignalLog.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    bd.SignalLogEntry = (function() {

        /**
         * Properties of a SignalLogEntry.
         * @memberof bd
         * @interface ISignalLogEntry
         * @property {Uint8Array|null} [apb_mac] SignalLogEntry apb_mac
         * @property {Uint8Array|null} [tag_mac] SignalLogEntry tag_mac
         * @property {number|null} [rssi] SignalLogEntry rssi
         */

        /**
         * Constructs a new SignalLogEntry.
         * @memberof bd
         * @classdesc Represents a SignalLogEntry.
         * @implements ISignalLogEntry
         * @constructor
         * @param {bd.ISignalLogEntry=} [properties] Properties to set
         */
        function SignalLogEntry(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * SignalLogEntry apb_mac.
         * @member {Uint8Array} apb_mac
         * @memberof bd.SignalLogEntry
         * @instance
         */
        SignalLogEntry.prototype.apb_mac = $util.newBuffer([]);

        /**
         * SignalLogEntry tag_mac.
         * @member {Uint8Array} tag_mac
         * @memberof bd.SignalLogEntry
         * @instance
         */
        SignalLogEntry.prototype.tag_mac = $util.newBuffer([]);
         ...
         * @instance
         */
        SignalLogEntry.prototype.rssi = 0;

        /**
         * Creates a new SignalLogEntry instance using the specified properties.
         * @function create
         * @memberof bd.SignalLogEntry
         * @static
         * @param {bd.ISignalLogEntry=} [properties] Properties to set
         * @returns {bd.SignalLogEntry} SignalLogEntry instance
         */
        SignalLogEntry.create = function create(properties) {
            return new SignalLogEntry(properties);
        };

        /**
         * Encodes the specified SignalLogEntry message. Does not implicitly {@link bd.SignalLogEntry.verify|verify} messages.
         * @function encode
         * @memberof bd.SignalLogEntry
         * @static
         * @param {bd.ISignalLogEntry} message SignalLogEntry message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SignalLogEntry.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.apb_mac != null && message.hasOwnProperty("apb_mac"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.apb_mac);
            if (message.tag_mac != null && message.hasOwnProperty("tag_mac"))
                writer.uint32(/* id 2, wireType 2 =*/18).bytes(message.tag_mac);
            if (message.rssi != null && message.hasOwnProperty("rssi"))
        ...
        /**
         * Encodes the specified SignalLogEntry message, length delimited. Does not implicitly {@link bd.SignalLogEntry.verify|verify} messages.
         * @function encodeDelimited
         * @memberof bd.SignalLogEntry
         * @static
         * @param {bd.ISignalLogEntry} message SignalLogEntry message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SignalLogEntry.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a SignalLogEntry message from the specified reader or buffer.
         * @function decode
         * @memberof bd.SignalLogEntry
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {bd.SignalLogEntry} SignalLogEntry
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignalLogEntry.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.bd.SignalLogEntry();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.apb_mac = reader.bytes().toString('hex');
                    break;
                case 2:
                    message.tag_mac = reader.bytes().toString('hex');
                    break;
                case 3:
        ...
        /**
         * Decodes a SignalLogEntry message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof bd.SignalLogEntry
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignalLogEntry.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SignalLogEntry message.
         * @function verify
         * @memberof bd.SignalLogEntry
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SignalLogEntry.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.apb_mac != null && message.hasOwnProperty("apb_mac"))
                if (!(message.apb_mac && typeof message.apb_mac.length === "number" || $util.isString(message.apb_mac)))
                    return "apb_mac: buffer expected";
            if (message.tag_mac != null && message.hasOwnProperty("tag_mac"))
                if (!(message.tag_mac && typeof message.tag_mac.length === "number" || $util.isString(message.tag_mac)))
                    return "tag_mac: buffer expected";
            if (message.rssi != null && message.hasOwnProperty("rssi"))
                if (!$util.isInteger(message.rssi))
                    return "rssi: integer expected";
            return null;
        ...
        /**
         * Creates a SignalLogEntry message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof bd.SignalLogEntry
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {bd.SignalLogEntry} SignalLogEntry
         */
        SignalLogEntry.fromObject = function fromObject(object) {
            if (object instanceof $root.bd.SignalLogEntry)
                return object;
            var message = new $root.bd.SignalLogEntry();
            if (object.apb_mac != null)
                if (typeof object.apb_mac === "string")
                    $util.base64.decode(object.apb_mac, message.apb_mac = $util.newBuffer($util.base64.length(object.apb_mac)), 0);
                else if (object.apb_mac.length)
                    message.apb_mac = object.apb_mac;
            if (object.tag_mac != null)
                if (typeof object.tag_mac === "string")
                    $util.base64.decode(object.tag_mac, message.tag_mac = $util.newBuffer($util.base64.length(object.tag_mac)), 0);
                else if (object.tag_mac.length)
                    message.tag_mac = object.tag_mac;
            if (object.rssi != null)
                message.rssi = object.rssi | 0;
            return message;
        };
        ...
        /**
         * Creates a plain object from a SignalLogEntry message. Also converts values to other types if specified.
         * @function toObject
         * @memberof bd.SignalLogEntry
         * @static
         * @param {bd.SignalLogEntry} message SignalLogEntry
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SignalLogEntry.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                if (options.bytes === String)
                    ...
                    object.apb_mac = [];
                    if (options.bytes !== Array)
                        object.apb_mac = $util.newBuffer(object.apb_mac);
                }
                if (options.bytes === String)
                    object.tag_mac = "";
                else {
                    object.tag_mac = [];
                    if (options.bytes !== Array)
                        object.tag_mac = $util.newBuffer(object.tag_mac);
                }
                object.rssi = 0;
            }
            if (message.apb_mac != null && message.hasOwnProperty("apb_mac"))
                object.apb_mac = message.apb_mac;
            if (message.tag_mac != null && message.hasOwnProperty("tag_mac"))
                object.tag_mac = message.tag_mac;
            if (message.rssi != null && message.hasOwnProperty("rssi"))
                object.rssi = message.rssi;
            return object;
        };
        ...
        /**
         * Converts this SignalLogEntry to JSON.
         * @function toJSON
         * @memberof bd.SignalLogEntry
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SignalLogEntry.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    bd.Empty = (function() {
         ...
         * @implements IEmpty
         * @constructor
         * @param {bd.IEmpty=} [properties] Properties to set
         */
         ...
         * @static
         * @param {bd.IEmpty=} [properties] Properties to set
         * @returns {bd.Empty} Empty instance
         */
        ...
        /**
         * Encodes the specified Empty message. Does not implicitly {@link bd.Empty.verify|verify} messages.
         * @function encode
         * @memberof bd.Empty
         * @static
         * @param {bd.IEmpty} message Empty message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Empty message, length delimited. Does not implicitly {@link bd.Empty.verify|verify} messages.
         * @function encodeDelimited
         * @memberof bd.Empty
         * @static
         * @param {bd.IEmpty} message Empty message or plain object to encode
        ...
        Empty.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.bd.Empty();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        Empty.fromObject = function fromObject(object) {
            if (object instanceof $root.bd.Empty)
                return object;
            return new $root.bd.Empty();
        };
